        ...
        <div className="relative glass rounded-3xl p-5 border border-white/5">
          ...
          <div className="flex items-center justify-between gap-2">
            <div className="flex gap-1.5">
              {[{Icon: Github, href: "https://github.com/mayank-1584"}, {Icon: Linkedin, href: "https://www.linkedin.com/in/mayank-sharma-ab539b283/"}, {Icon: Target, href: "https://leetcode.com/u/tGwSk8GHrt/"}, {Icon: Instagram, href: "https://www.instagram.com/mayank_1584/"}, {Icon: Trophy, href: "https://codeforces.com/profile/mksharmakaku1584"}].map(({Icon, href}, i) => (
                <a
                  key={i}
                  href={href}
                  aria-label="social"
